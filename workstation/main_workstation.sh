...
echo -e "\n****************************"
echo -e "EXECUTION SCRIPT WORKSTATION"
echo -e "****************************\n"
...
nb_scripts=$(($(ls -1 workstation/level2/*.sh | wc -l)*2)) #CHEMIN d'exécution depuis le main.sh (nombre de scripts)

# Chemin vers le dossier contenant les scripts de niveau 2
script_level2="workstation/level2" #(liste les scripts)
